...
def main():
    ...
    with st.sidebar:
        ...
        **CSV Format Requirements:**
        ...
        - Times in "HH:MMa/p" format
        - Each work day generates 2 rows: morning and afternoon punches
        """)
                    ...
                    try:
                        ...
                        with tempfile.TemporaryDirectory() as temp_dir:
                            ...
                            with result_col2:
                                ...
                                png_path = os.path.join(temp_dir, 'timeclock_detailed_heatmap.png')
                                ...
                                if os.path.exists(png_path):
                                    ...
                                    # Also display the PNG
                                    st.image(png_path, caption="Time Clock Heat Map", use_column_width=True)
